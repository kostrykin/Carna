...
class BinaryMaskDemo
{

    class BinaryMask : public Carna::base::model::ScalarField< Carna::base::model::BufferedMaskAdapter::BinaryMask::ValueType >
    {
    ...
    public:
        ...
        BinaryMask( const Carna::base::Vector3ui& size )
            : size( size )
        {
        }
        ...
        scene.setVolumeMask(
            new Carna::base::model::BufferedMaskAdapter(
                new Carna::base::Composition< Carna::base::model::BufferedMaskAdapter::BinaryMask >(
                    new Carna::base::model::BufferedMaskAdapter::BinaryMask
                        ( scene.volume().size
                        , BinaryMask( scene.volume().size ) ) ) ) );
