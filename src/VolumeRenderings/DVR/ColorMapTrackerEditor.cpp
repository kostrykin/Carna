    ...
    , sbHuv( new QSpinBox() )
{
    ...
    base::qt::WideColorPicker* colorPicker = new base::qt::WideColorPicker( current_color );
...
{
    const unsigned int spanIndex = colorIndex / 2;
    const base::IntSpan& orig_span = widget.getSpan( spanIndex );
    base::IntSpan span = orig_span;
